<?php
/* Smarty version 4.3.4, created on 2024-08-29 10:53:52
  from '/home/u255923749/domains/smartrecruitmentsolution.com/public_html/techom/layouts/v7/modules/Users/DetailViewBlockView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_66d053408cc352_94421235',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a72961384b1b57f9e0cea719aac2dd092553a607' => 
    array (
      0 => '/home/u255923749/domains/smartrecruitmentsolution.com/public_html/techom/layouts/v7/modules/Users/DetailViewBlockView.tpl',
      1 => 1724928830,
      2 => 'file',
    ),
  ),
...
function content_66d053408cc352_94421235 (Smarty_Internal_Template $_smarty_tpl) {
...
' /><input type='hidden' name='pwd_regex' value= <?php echo ZEND_json::encode($_smarty_tpl->tpl_vars['PWD_REGEX']->value);?>
 /><nav class="navbar-right"></nav><?php
...
<style>
  .block[data-block="LBL_MORE_INFORMATION"] {
    display: none;
  }
   .block[data-block="LBL_CURRENCY_CONFIGURATION"] {
    display: none;
  }
   .block[data-block="LBL_ADDRESS_INFORMATION"] {
    display: none;
  }
...
document.addEventListener('DOMContentLoaded', function() {
    var loginRoleBlock = document.querySelector('.block[data-block="LBL_USERLOGIN_ROLE"]');
    if (loginRoleBlock) {
        var tableBody = loginRoleBlock.querySelector('tbody');
        if (tableBody && tableBody.children.length >= 5) {
            tableBody.removeChild(tableBody.children[4]);
        }
       
        var thirdRow = tableBody.children[2];
        if (thirdRow && thirdRow.children.length >= 2) {
            thirdRow.children[0].style.display = 'none';
            thirdRow.children[1].style.display = 'none';
        }
       
        var fourthRow = tableBody.children[3];
        if (fourthRow && fourthRow.children.length >= 2) {
            fourthRow.children[0].style.display = 'none';
            fourthRow.children[1].style.display = 'none';
        }
    }
});
<?php echo '</script'; ?>
