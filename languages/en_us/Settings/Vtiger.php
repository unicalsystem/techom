...
$languageStrings = array(
	...
	'LBL_WORKFLOWS_ACTIVE' => 'Smartflows',
	'LBL_MODULES' => 'Modules',
	...
	// Other Strings
	'LBL_USER_DESCRIPTION' => 'Manage users who can access SRS',
	'LBL_ROLES' => 'Roles',
	'LBL_ROLE_DESCRIPTION' => 'Set up hierarchy of roles and assign to the users',

	'LBL_PROFILES' => 'Candidates',
	'LBL_PROFILE_DESCRIPTION' => 'Manage user-specific modules access to different Roles',

	'USERGROUPLIST' => 'Teams',
	'LBL_GROUP_DESCRIPTION' => 'Manage different types of teams based on roles, users, and candidates',

	'LBL_SHARING_ACCESS' => 'Data Control',
	'LBL_SHARING_ACCESS_DESCRIPTION' => 'Manage module sharing rules & custom sharing rules',

	'LBL_WORKFLOW_LIST' => 'Smartflow List',
	'LBL_AVAILABLE_WORKLIST_LIST' => 'Available Smartflows',
	...
	'VTLIB_LBL_MODULE_MANAGER_DESCRIPTION' => 'Manage module behavior inside SRS',
	...
	'LBL_LIST_WORKFLOWS' => 'Smartflows',
	'LBL_LIST_WORKFLOWS_DESCRIPTION' => 'Create and edit smartflows',
	...
	'LBL_WEBFORMS_DESCRIPTION' => 'Create and manage webforms which can be used to capture Candidates, Candidates, Tickets etc',
	...
	'LBL_DEFAULT'=>'By default, SMTP account settings for the outgoing server are configured to od1.srs.com mail server. To avoid outgoing emails getting filtered out by spam filters on your recipient ISP mail server, we recommend you implement one of the following.',
	...
	'LBL_OPTIONS2'=>"Add srs.com server as an authorized sender of emails for your domain <b>(your_company.com)</b> when you are using your <b>From Email (eg : support@your_company.com)</b>.<br>
	...
	'LBL_CONFIG_DESCRIPTION' => 'Edit the Configuration details of SRS',
    ...
    'MAIN_PRODUCT_WHITELABEL' => 'SRS white labeling',
    'LBL_WHITE_LABELING_INFO' => 'Enabling this will remove feedback icon, video links, new feature videos and footer from SRS.',
    'LBL_WHITE_LABELING_INFO_MSG' => 'Enabling this will remove help button and footer from SRS.',
    ...
    'LBL_LEAD_MAPPING' => 'Candidate Conversion Data Mapping',
...
$jsLanguageStrings = array(
	'JS_PLEASE_SELECT_ATLEAST_ONE_MEMBER_FOR_A_GROUP' => 'Please select atleast one member for a team',
	'JS_GROUP_DELETED_SUCCESSFULLY' => 'Team deleted successfully',
