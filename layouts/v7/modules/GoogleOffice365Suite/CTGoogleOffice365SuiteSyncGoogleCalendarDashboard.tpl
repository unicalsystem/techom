...
<div class="dashboard1"><br>
	{if $NUMOFUSERROWS eq 0 && $ISADMIN eq 'off'}
		<table class='table table-bordered step1'>
			<thead>
				<tr>
					<th class="goBack"><center>{vtranslate('LBL_GOOGLE_CALENDAR_ACCESS_DENIED', $MODULE)}</center></th>
				</tr>
				<tr>
					<td class="goBack">
						<center>
	...
	{else}
		...
		<center>
			<div class="ds-header dashboard2 dashboard3 mt-10"><br>
				<center>
					<b class="goBack">{vtranslate('LBL_CONFIGURE_GOOGLE_CALENDAR', $MODULE)}</b><br><br>
				</center>
			</div>
		</center><br>
		<div>
			...
			<div class="col-md-4 pull-left">
				<div class="ds-header dashboard3">
					<center>
						...
						<h2><b class="dashdescriptionstep3">{vtranslate('LBL_GENERATE_TOKEN', $MODULE)} {vtranslate('LBL_AND', $MODULE)} {vtranslate('LBL_CONFIGURE_CALENDAR_SETTING', $MODULE)}</b></h2>
			...
			<div class="col-md-4 pull-left">
				<div class="ds-header dashboard3">
					<center>
						...
						<h2><b class="dashstep1">{vtranslate('LBL_SYNC_GOOGLE_CALENDAR', $MODULE)}</b></h2>
						<h2><b class="dashdescriptionstep3" title="{vtranslate('LBL_SYNC_CALENDAR_LOG', $MODULE)}">{vtranslate('LBL_SYNC_CALENDAR_LOG', $MODULE)}</b></h2>
