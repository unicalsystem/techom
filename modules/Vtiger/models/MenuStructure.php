...
class Vtiger_MenuStructure_Model extends Vtiger_Base_Model {
	...
	static function sortMenuItemsByProcess($a, $b) {
		...
		if ($order == NULL) {
			$order = array(
			    'Contacts',  # changed the menu strcture 08-05-2024
				'Campaigns',
				'Leads',
				'Accounts',
				'Potentials',
	...
	public static function getAppMenuList(){
		return array('SALES','MARKETING','INVENTORY','SUPPORT','PROJECT','TOOLS'); #changed menu
	}

	public static function getAppIcons() {
		$appImageIcons = array(	
		                        'SALES'		=> 'fa-dot-circle-o',  # changed menu strcture
		                        'MARKETING' => 'fa-users',
