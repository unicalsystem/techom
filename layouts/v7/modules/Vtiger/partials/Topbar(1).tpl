...
{strip}
				...
				<div class="col-sm-3">
					...
					<li style="margin-right: 15px; text-align: center;">
						<a href="index.php?module=Potentials&amp;view=List&amp;app=SALES" title="Openings" class="shortcut-icon">
							<img src="layouts/v7/resources/Images/icons/openings.png" alt="Openings" style="width: 22px;height: 25px;">
					...
					<li style="margin-right: 15px;">
						<div class="whatsapp-container">
							<a href="#" id="whatsapp-chat-icon" title="WhatsApp Chat" class="shortcut-icon">
								<img src="layouts/v7/resources/Images/icons/whatsapp.png" alt="WhatsApp" style="width: 22px;height: 24px;">
							...
							<div class="dropdown pull-left">
								<div class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
									<a href="#" id="menubar_quickCreate" class="" title="{vtranslate('LBL_QUICK_CREATE',$MODULE)}" aria-hidden="true">
									 <img src="layouts/v7/resources/Images/icons/Create.png" alt="Create" style="width: 23px; height: 25px;">
									</a>
								</div>
    ...
    <div>
        <a href="index.php?module=Calendar&view={$CALENDAR_MODULE_MODEL->getDefaultViewName()}" title="{vtranslate('Calendar','Calendar')}" aria-hidden="true">
            <img src="layouts/v7/resources/Images/icons/Calender.png" alt="Calendar" style="width: 22px; height: 22px;">
        </a>
    </div>
</li>
						{/if}
    ...
    <div>
        <a href="index.php?module=Reports&view=List" title="{vtranslate('Reports','Reports')}" aria-hidden="true">
            <img src="layouts/v7/resources/Images/icons/Report.png" alt="Reports" style="width: 22px; height: 22px;">
        </a>
    </div>
</li>
						{/if}
        ...
        <div>
            <a href="#" class="taskManagement" title="{vtranslate('Tasks','Vtiger')}" aria-hidden="true">
                <img src="layouts/v7/resources/Images/icons/Task.png" alt="Tasks" style="width: 22px; height: 22px;">
            </a>
        </div>
    </li>
						{/if}
						<li class="dropdown">
							<div>
								<a href="#" class="userName dropdown-toggle pull-right" data-toggle="dropdown" role="button">
									 <img src="layouts/v7/resources/Images/icons/Profilesetting.png" alt="Profile Settings" style="width: 22px; height: 22px;">
