<?php
/*+***********************************************************************************
 * The contents of this file are subject to the SRS CRM Public License Version 1.0
 * ("License"); You may not use this file except in compliance with the License
 * The Original Code is:  SRS CRM Open Source
 * The Initial Developer of the Original Code is SRS.
 * Portions created by SRS are Copyright (C) SRS.
 * All Rights Reserved.
 *************************************************************************************/
$languageStrings = array(
	...
	//Changed Organisation Name to Client Name #Shiva #SRS_US107
	'Related To' => 'Client Name',
	...
	'customer_portal' => 'in the "Customer Portal" at SRS.',
	'link' => 'You can use the following link to view the replies made:',
	'Thanks' => 'Thanks',
	'Support_team' => 'SRS Support Team',
	'The comments are' => 'The comments are',
	'Ticket Title' => 'Ticket Title',
	'Re' => 'Re :',

	//This label for customerportal.
	'LBL_STATUS_CLOSED' =>'Closed',//Do not convert this label. This is used to check the status. If the status 'Closed' is changed in SRS server side then you have to change in customerportal language file also.
