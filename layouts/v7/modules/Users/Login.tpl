...
<div class="container-fluid loginPageContainer">
    <div class="col-lg-4 col-lg-offset-4 col-md-12 col-sm-12 col-xs-12">
        <div class="loginDiv widgetHeight">
            <img class="img-responsive user-logo" src="layouts/v7/resources/Images/homepage_logo.png">
            <div>
            ...
            <div id="loginFormDiv">
                <form class="form-horizontal" method="POST" action="index.php">
                    ...
                    <div class="g-recaptcha" data-sitekey="6Ld2ABEqAAAAAKPyjTWKchFOzAexvk1FdBILK5PJ"></div>
                    <div class="group">
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            forgotPasswordDiv.find('button').on('click', function (e) {
               ...
               var forgotPasswordRecaptcha = forgotPasswordDiv.find('.g-recaptcha');
    var widgetId = grecaptcha.render(forgotPasswordRecaptcha[0], {
        'sitekey': '6Ld2ABEqAAAAAKPyjTWKchFOzAexvk1FdBILK5PJ'
    });
    forgotPasswordRecaptcha.data('widget-id', widgetId);
