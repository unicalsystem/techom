...
class CTBrowserExt_ICAL {
	...
	static function process($username, $password) {
		$mobileical = new CTBrowserExt_ICAL();
...
// url format: http://localhost:81/modules/CTBrowserExt/ical.php/username@mail.com/password
...
if (vtlib_isModuleActive('Mobile')) {
	CTBrowserExt_ICAL::process($matches[1], $matches[2]);
}
