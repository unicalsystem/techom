    ...
    {if $USER_MODEL->isAdminUser()}
        ...
        <div class="settingsgroup">
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                {assign var=blockCounter value=0}
                {foreach item=BLOCK_MENUS from=$SETTINGS_MENUS}
                    {if $blockCounter neq 4 && $blockCounter neq 5 && $blockCounter neq 8 && $blockCounter neq 9}
                        ...
                        {/if}
                    {/if}
                    {assign var=blockCounter value=$blockCounter+1}
                {/foreach}
            </div>
        </div>
    {else}
