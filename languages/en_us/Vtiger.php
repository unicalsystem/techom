<?php
/*+***********************************************************************************
 * The contents of this file are subject to the SRS CRM Public License Version 1.1
...
$languageStrings = array(
	...
	'LBL_ADD_COMMENT' => 'Add Note',
	'LBL_EDIT_FIELDS' => '%s Fields & Layout',
	'LBL_EDIT_WORKFLOWS' => '%s Smartflows',
	...
	'LBL_MARKETING_AND_SALES' => 'MARKETING & RECRUITMENTS',
	'LBL_TOOLS_HEADER' => 'ACCELERATORS',
	'LBL_SUPPORT' => 'COORDINATION',
	'LBL_INVENTORY' => 'INVENTORY',
	'LBL_ANALYTICS' => 'ANALYTICS',
	'LBL_CONTACT' => 'CONTACT MANAGEMENT',
	'LBL_HOME' => 'Home',
	'LBL_NO_ATTACHMENTS' => 'No Attachments',
	'LBL_COMPOSE_EMAIL_WARNING' => ' Warning : Your email might land in spam. Add SRS as an authorized sender for your domain. Learn more',
	// Common Link Labels
	...
	'LBL_CRM_SETTINGS' => 'System Settings',
	...
	'LBL_ADD_NEW_COMMENT' =>'Add New Note',
	...
	'LBL_ADD_YOUR_COMMENT_HERE' => 'Add your Note here...',
	'LBL_REASON_FOR_CHANGING_COMMENT' => 'Reason for changing Note',
	'LBL_REPLY' => 'Reply',
	'LBL_VIEW_THREAD' => 'View Thread',
	'LBL_NO_COMMENTS' => 'No Notes',
	'LBL_REPLIES' => 'replies',
	'LBL_REPLY_ALL' => 'Reply all',
	'LBL_INTERNAL_COMMENT_TOOTLTIP' => 'Customers cannot see this Note',
	'LBL_EXTERNAL_COMMENT_TOOTLTIP' => 'Customers might see this Note via notifications or customer portal',
	...
	'LBL_ADD_GROUP' => 'Add Condition Team',
	...
	'LBL_COPY_BILLING_ADDRESS' => 'Address',
	...
	'LBL_NO_UPDATES_OR_COMMENTS' => 'No updates or Notes',
	...
	'Pipelined Amount' => 'Recruitments Pipeline',
	'Total Revenue' => 'Total Revenue',
	'Top Potentials' => 'Top Openings',
	'Forecast' => 'Forecast',
	'Leads Created' => 'Profiles Created',
	'Leads by Status' => 'Profiles by Status',
	'Leads by Source' => 'Profiles by Source',
	'Leads by Industry' => 'Profiles by Skillset',
	'Tickets by Status' => 'Tickets by Status',
	'Open Tickets' => 'Open Tickets',
	'Funnel Amount' => 'Total Amount by Recruitment Status',
	'Key Metrics' => 'KPIs',
	'Mini List' => 'Mini List',
	'Tag Cloud' => 'Tag Cloud',
	'Notebook' => 'Notebook',
	...
	'LBL_TYPE_AND_SEARCH' => 'Type and Search',
		'LBL_EXPORT_CURRENCY_TOOLTIP_TEXT'=>'For exporting Currency values in Line items, SRS will use this setting to export as this currency. Any currency values outside the line items tables, will be exported as in User\'s preferred currency (selected in \'My Preferences\')',
	...
	'Is Converted From Lead' => 'Is Converted From Profile',
	...
	'Sales Start Date'=>'Recruitments Start Date',
	'Sales End Date'=>'Recruitments End Date',
	...
	'LBL_VTIGER_CRM_HONEST_OPEN_SOURCE' => 'SRS On Demand',

	//Translations used in inventory modules for sopy address
	'SINGLE_Accounts' => 'Client',
	...
	'Projects' => 'Projects',
	'Sales Order' => 'Recruitments Orders',
	...
	'Comment' => 'Note',
	'Last Comment' => 'Last Note',
	'Last 5 Comments' => 'Last 5 Notes',
	'All Comments' => 'All Notes',
	...
	'LBL_INTERNAL_COMMENT' => 'Internal Note',
	...
	'COMPANY_LOGO_HELP_TEXT' => 'Please upload your lovely company logo. <br>Besides showing your company logo on your SRS,<br>
	...
	'COMPANY_LOGO_HELP_TEXT_2' =>"You can edit company details later from <br>
									'SRS Settings > Templates > Company Details' page",
	...
	'PREFERENCES_HELP_TEXT' => 'Base Currency - Choose your primary currency. If you use multiple<br> 
								...
								using the conversion rate configured in SRS.',
	...
	'IMPORT_CONTACTS_GOOGLE_HELP_TEXT' => 'We can bring Contacts from Google and <br> you can also enable bi-direction sync to keep our<br>
									SRS Contacts and Google Contacts(in selected Team) updated.<br>
	...
	'IMPORT_CONTACTS_CSV_HELP_TEXT2' => 'To Import Openings, Profiles, Tickets, please look for Actions > Import button on any of the
										 list views.',
	...
	'TELL_US_ABOUT_YOU_HELP_TEXT' => 'We continue to make improvements to the SRS, and <br>
	...
	'LBL_SOCIAL_LINKED' => 'Your SRS is now linked to',
	'LBL_ENTER_KEYWORDS_HELP'=>'SRS will scan twitter and find messages with these words',
	...
	'LBL_ADD_OPPORTUNITY' => 'Add Opening',
	'LBL_RETWEET' => 'Retweet',
	...
	'LBL_ADD_OPPORTUNITY_CONTACT' => 'Add Opening + Contact',
	...
	'LBL_VIEW_OPPORTUNITY' => 'View Opening',
	...
	'LBL_DEFAULT_REPLY_TO_INFO' => 'This setting is applicable only for direct emails from SRS. It doesn\'t affect emails sent from smartflows, email campaigns, etc.', 
	'search_in_all_fields'=>'Search in All fields',
	'search_in_name_field'=>'Search in Name field',
	'LBL_LOOKUP_SEARCH_MODE_INFO'=>'Ex: In Contact creation form, when you enter text in the Client name box this setting will control what fields in Client are to be searched',
	...
	'LBL_ROLLUP_COMMENTS_INFO' => "If Roll up is set to 'On' Notes on related records will be shown. 
								 For example, if you are viewing Notes on an Client record, Notes added to related Contacts, Openings, Tickets, ..etc would also be displayed.",
	'LBL_ROLLUP_COMMENTS' => "Rollup Notes",
	...
	'LBL_SHARED_TAGS_ACCESS'=>'Shared tags are accessible by all users in SRS',
	...
	'LBL_TIME' => 'Time',
	'LBL_SKIPPED' => 'Skipped',
	'vt_create' => 'Records Created in SRS',
	'vt_update' => 'Records Updated in SRS',
	'vt_delete' => 'Records Deleted in SRS',
	'vt_skip' => 'Records skipped in SRS',
	...
	'SINGLE_SalesOrder' => 'Recruitments Order',
	'SINGLE_PurchaseOrder' => 'Purchase Order',
	'SINGLE_Quotes' => 'Quote',
	'LBL_POST_YOUR_COMMENT_HERE' => 'Post your Notes here',
	// Phone Calls
	...
	'LBL_INTERNAL_COMMENT_INFO' => 'The Note will only be seen by SRS users, if the internal Note checkbox is enabled. To notify customers (through configurable smartflows or customer portal) leave this checkbox disabled',
	'LBL_CHANGE' => 'Change',
	...
	. 'For example, if a new support email comes from john@company.com, it would be linked to Client that has '
	. 'company.com in the Email domain field. Multiple domains should be separated by commas',

	'LBL_SHARED_LIST_NON_ADMIN_MESSAGE' => 'This is a Shared list. Please Contact your SRS Administrator to configure columns for All list',
	...
	'Prof.' => 'Prof.',
	'SINGLE_Cases'=>'Case',
	'LBL_TAX_MODE_INFO' =>'If Individual, Taxes will be picked from Product record. If Team, Taxes will be picked from Global settings.',
	...
	'LBL_CHAT_WITH_SUPPORT' => 'Live chat with SRS expert',

	'LBL_ROLES' => 'Roles',
	'LBL_ROLEANDSUBORDINATE' => 'Role and Subordinates',
	'LBL_YOUR_LEARNING_SCORE' => 'Your SRS learning score',
	'LBL_SWITCH_TO_VTIGER7_NOW' => 'Switch to SRS by Feb 15th',
	...
	'LBL_DUPLICATES_FOUND_MESSAGE' => 'This %s cannot be saved since duplicate %s exists in SRS with matching values for %s.',
	'LBL_VTIGER_NOTIFICATION' => 'Message from : SRS System Notifications',
	'LBL_DUPLICATION_FAILURE_FROM_WORKFLOWS' => 'The following %s could not be saved from "%s" smartflow, as another %s exists with the same values.',
	...
	'LBL_KANBAN_VIEW_INFO' => 'Kanban view shows only the openings that match conditions of this list',
...
$jsLanguageStrings = array(
	...
	'JS_DUPLICTAE_CREATION_CONFIRMATION' => 'Client Name already Exists.Do you want to create a duplicate record?',
	...
	'JS_PLEASE_ENTER_SOME_TEXT_FOR_COMMENT' => 'Please enter some text for Note',
	'JS_LBL_COMMENT_VALUE_CANT_BE_EMPTY' => 'Note value cannot be empty',
	...
	'JS_PLEASE_SELECT_AN_ACCOUNT_TO_COPY_ADDRESS' => 'Please select an Client to copy address',
	'JS_PLEASE_SELECT_AN_CONTACT_TO_COPY_ADDRESS' => 'Please select a Contact to copy address',
	'JS_SELECTED_ACCOUNT_DOES_NOT_HAVE_AN_ADDRESS' => 'Selected Client does not contain address to copy',
	...
	'JS_SELECT_RECORDS_TO_MERGE_FROM_SAME_GROUP' => 'You have to select the records in the same teams for merging',
	...
	'LBL_WARNING' => 'Warning',
	'DELETE_USER_PERMANENT_WARNING' => 'Deleting a user permanently will transfer all records including Notes and history to new user.',
	'JS_DECIMAL_SEPARATOR_AND_GROUPING_SEPARATOR_CANT_BE_SAME' => 'Decimal separator and Teaming separator cant be same',
	'JS_FUTURE_EVENT_CANNOT_BE_HELD' => 'Cannot Be Held For Future',
	'JS_CLOSE' => 'Close',

	// For Line Iteam Currency Symbol select while Import
	'JS_CURRENCY_TOOLTIP_CONTENT_TITLE' => 'Line Items Currency',
	'JS_CURRENCY_TOOLTIP_CONTENT_MESSAGE' => 'For importing Currency values in Line items, SRS will use this setting to identify the currency. Any currency values outside the line items tables, are assumed to be in User\'s preferred currency (selected in \'My Preferences\')',
	...
	'JS_PLEASE_SELECT_AN_RELATED_TO_COPY_ADDRESS' => 'Please select a Profile / Contact Module to copy address',
	'SINGLE_Leads' => 'Profile',
	'JS_SELECTED_LEAD_DOES_NOT_HAVE_AN_ADDRESS' => 'Selected Profile does not contain address to copy',
	'JS_INVALID_EMAILS' => 'Invalid Emails',
	'JS_DIRECTORY_IS_EMPTY' => 'Directory is empty',
	'JS_NO_LINE_ITEM' =>'Line items cannot be empty.',
	'JS_INTERNAL_COMMENT' => 'Internal Note',
	'JS_INTERNAL_COMMENT_INFO' => 'The Note will only be seen by SRS users, if the internal Note checkbox is enabled. To notify customers (through configurable smartflows or customer portal) leave this checkbox disabled',
	...
	'JS_SUITABLE_VTIGER_FIELD_NOT_AVAILABLE_FOR_MAPPING' => 'Suitable SRS field not available for mapping',
	...
	'JS_LEAD_ADDED_SUCCESS_MSG' => 'Profile added successfully',
	'JS_OPPORTUNITY_ADDED_SUCESS_MSG' => 'Opening added successfully',
	...
	'JS_MORE_VTIGER' => 'There are more records to be synchronized in SRS',
	...
	'JS_LBL_HELP' => 'Help',
	'JS_LBL_HELP_TEXT' => 'Click on Help button to find Guides and FAQs, and use the Help menu dropdown to get assistance from SRS support team',
	...
	'JS_TAB_REORDERED' =>'Reordered',
	//Convert Lead
	'JS_CONVERT_LEAD_ERROR' => 'You have to enable either Clients or Contacts module to convert the Profile.',
	...
	'JS_KANBAN_NO_ANCHORS_CONFIGURED' => "You do not have any Recruitments stages defined for your Recruitments pipeline.",
	'JS_KANBAN_NO_ANCHORS_CONFIGURED_NON_ADMIN' => "You do not have any recruitments stages defined for your Recruitments pipeline. Please Contact your Administrator to define recruitment stages as per your recruitments process.",
	...
	'JS_WARNING' => 'Warning',
	'JS_CANT_SELECT_LEAD' => 'Cannot select related Profile',
	...
	'JS_COMMENT_POSTED_SUCCESSFULLY'=>'Note posted successfully',
	...
	'JS_SHARED_PUBLICLY_TITLE'=>'Public Conversation can also be viewed by users outside the linked mailboxes, if they have access to the related Contact ,Opening ..etc',
	...
	'JS_WIDGET_RESIZING_WAIT_MSG' => 'Widget contents will load after resizing.',
        ...
        'JS_RELATED_ACCOUNT_IS_NOT_AVAILABLE' => 'Related Client record is not available',
