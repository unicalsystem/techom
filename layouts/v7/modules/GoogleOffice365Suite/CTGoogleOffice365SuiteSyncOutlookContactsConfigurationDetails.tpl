	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="clearfix">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				 <h3 class="span4 textOverflowEllipsis" title="{vtranslate('LBL_OUTLOOK_API_SETTING', $MODULE)}" style="height: 30px;">{vtranslate('LBL_CONFIGURE_CTOUTLOOK_CONTACTS', $MODULE)}</h3>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				<div class="btn-group pull-right">
				    <button onclick='window.location.href = "index.php?module=GoogleOffice365Suite&view=CTGoogleOffice365SuiteSyncOutlookContactDashboard"' class="btn btn-default"	>{vtranslate('LBL_BACK', $MODULE)}</button>
				</div>
				<div class="btn-group pull-right">
					<button class="btn btn-default editButton" style="margin-right: 10px;" onclick='window.location.href = "index.php?module=GoogleOffice365Suite&view=CTGoogleOffice365SuiteSyncOutlookContactsConfigurationEdit"' type="button" title="{vtranslate('LBL_EDIT', $MODULE)}">{vtranslate('LBL_EDIT', $MODULE)}</button>
				</div>
				<div class="btn-group pull-right" style="margin-right: 10px;">
					<button class="btn btn-default editButton" onclick='window.location.href = "https://outlook.office.com/people/"' type="button" title="{vtranslate('LBL_CTOUTLOOK_CONTACT_DASHBOARD', $MODULE)}">{vtranslate('LBL_CTOUTLOOK_CONTACT_DASHBOARD', $MODULE)}</button>
				</div>
			</div>
		</div>
