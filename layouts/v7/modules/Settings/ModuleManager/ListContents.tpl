                                    ...
                                    <td class="ModulemanagerSettings">
                                        <div class="moduleManagerBlock">
                                            <span class="col-lg-1" style="line-height: 2.5;">
                                                <input type="checkbox" value="" name="moduleStatus" data-module="{$MODULE_NAME}" data-module-translation="{$MODULE_LABEL}" {if $MODULE_ACTIVE}checked{/if} />
                                            </span>
                                            <span class="col-lg-1 moduleImage">
                                            ...
                                            <span class="col-lg-7 moduleName"><h5 style="line-height: 0.5;">{$MODULE_LABEL}</h5></span>
