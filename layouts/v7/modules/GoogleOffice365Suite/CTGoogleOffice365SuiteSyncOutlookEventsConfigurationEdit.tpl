...
<div class="container-fluid editViewContainer">
    ...
    <div class="col-sm-12 col-xs-12" id="EditView">
        <form name="editOutlookEvents"  class="form-horizontal">
            <div class="editViewBody">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5 controls">
                        <input type="text" class="form-control inputElement" id="tanentId" name="tanentId" value="{$TENATID}" data-validation-engine="validate[required]">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-3 control-label" >
            ...
            <br>
                <div class="row-fluid">
                    <div class="pull-right">
                        <button type="button" class="btn btn-success" id="saveOutlookEventsAPIsSetting" name="saveOutlookEventsAPIsSetting">{vtranslate('LBL_SAVE', $QUALIFIED_MODULE)}</button>
