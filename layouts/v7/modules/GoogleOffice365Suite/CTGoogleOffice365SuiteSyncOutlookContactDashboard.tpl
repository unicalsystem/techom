    ...
    {else}
        ...
        <center>
            <div class="ds-header dashboard2" style="border: 1px solid;"><br>
                <center>
                    <b style="font-size: 14px;">{vtranslate('LBL_CONFIGURE_CTOUTLOOK_CONTACTS', $MODULE)}</b><br><br>
                </center>
            </div>
        </center><br>
        <div>
                <div class="col-md-4 pull-left">
                    <div class="ds-header dashboard3" style="border: 1px solid;">
                        <center>
                            ...
                            <h2><b style="font-size: 12px;height:15px;display: inline-block;width: 250px;white-space: nowrap;overflow: hidden !important;text-overflow: ellipsis;">{vtranslate('LBL_CTOUTLOOK_CONFIGURE_CREDENTIALS', $MODULE)} </b></h2>
                ...
                <div class="col-md-4 pull-left">
                    <div class="ds-header dashboard3" style="border: 1px solid;">
                        <center>
                            ...
                            <h2><b style="font-size: 12px;height:15px;display: inline-block;width: 250px;white-space: nowrap;overflow: hidden !important;text-overflow: ellipsis;">{vtranslate('LBL_GENERATE_TOKEN', $MODULE)} {vtranslate('LBL_AND', $MODULE)} {vtranslate('LBL_CONFIGURE_OUTLOOK_CONTACTS_SETTING', $MODULE)}</b></h2>
                ...
                <div class="col-md-4 pull-left">
                    <div class="ds-header dashboard3" style="border: 1px solid;">
                        <center>
                            ...
                            <h2><b style="font-size: 18px;">{vtranslate('LBL_SYNC_OFFICE_CONTACTS', $MODULE)}</b></h2>
                            <h2><b style="font-size: 12px;height:15px;display: inline-block;width: 250px;white-space: nowrap;overflow: hidden !important;text-overflow: ellipsis;" title="{vtranslate('LBL_SYNC_LOG', $MODULE)}">{vtranslate('LBL_SYNC_CONTACTS_LOG', $MODULE)}</b></h2>
