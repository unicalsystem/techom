...
<div id="listViewPageDiv">
  <div class="listViewTopMenuDiv">
    <div class="col-md-12">
      <div class="col-md-5">
        <p style="margin-top:5px; color: #3d78f9; font-size: 18px">
          <a href="#">{vtranslate('LBL_OUTLOOK', $QUALIFIED_MODULE)} > </a><a href="#">{$GOOGLEUSER}</a>
        </p>
        <h3>{vtranslate('LBL_SYNC_OUTLOOK_CALENDAR_CONTACT', $QUALIFIED_MODULE)}</h3>
      </div>
      <div class="col-md-7 text-right">
        <button onclick='window.location.href = "index.php?module=GoogleOffice365Suite&view=List"'
          class="btn btn-success mr-5 br-3">{vtranslate('LBL_HOME', $QUALIFIED_MODULE)}
        </button>

        <button onclick='window.location.href = "index.php?module=GoogleOffice365Suite&view=CTGoogleOffice365SuiteSyncOutlookContactsGenerateToken"' class="btn btn-success contactBackBtn mr-5 br-3">{vtranslate('LBL_OUTLOOK_CONTACT_SETTING', $QUALIFIED_MODULE)}</button>

        <button onclick='window.location.href = "index.php?module=GoogleOffice365Suite&view=CTGoogleOffice365SuiteSyncOutlookEventsGenerateToken"' class="btn btn-success contactBackBtn mr-5 br-3">{vtranslate('LBL_OUTLOOK_EVENTS_SETTINGS', $QUALIFIED_MODULE)}</button> 
      ...
      <div class="col-md-12 manual-sync">
        ...
        <div class="col-md-8">
          <button class="btn btn-success contactBackBtn br-3 mr-5" 
            ...
            disabled
            {else}
            id="syncFromOutlookContact"
            {/if}
             title="{vtranslate('LBL_TITLE_SYNC_OUTLOOK_TO_VTIGER', $QUALIFIED_MODULE)}">
          ...
          <button class="btn btn-success contactBackBtn br-3"
            ...
            {/if} title="{vtranslate('LBL_TITLE_SYNC_VTIGER_TO_OUTLOOK', $QUALIFIED_MODULE)}">
            {vtranslate('LBL_LOG_SYNC_TO_OUTLOOK', $QUALIFIED_MODULE)} <i class="fa fa-arrow-up"></i>
          </button>
        </div>
        {if $CON_SETTING_STATUS eq 0}
         <div class="col-md-8 mt-10">
          <span style="color:red;">{vtranslate('LBL_CON_DISABLE_BTN_NOTE', $QUALIFIED_MODULE)} <a href="index.php?module=GoogleOffice365Suite&view=CTGoogleOffice365SuiteSyncOutlookContactsGenerateToken"><u>here</u></a><span>
        </div>
        {/if}
      </div>
      <div class="col-md-12 manual-sync">
        ...
        <div class="col-md-8">
          ...
          <button class="btn btn-success br-3 mr-5"
            ...
            disabled
            {else}
            id="syncFromOutlookEvent"
            {/if} title="{vtranslate('LBL_TITLE_SYNC_OUTLOOK_TO_VTIGER', $QUALIFIED_MODULE)}">
            {vtranslate('LBL_LOG_SYNC_TO_VTIGER', $QUALIFIED_MODULE)} <i class="fa fa-arrow-down"></i>
          </button>
        ...
        {if $CAL_SETTING_STATUS eq 0}
         <div class="col-md-8 mt-10">
          <span style="color:red;">{vtranslate('LBL_CAL_DISABLE_BTN_NOTE', $QUALIFIED_MODULE)} <a href="index.php?module=GoogleOffice365Suite&view=CTGoogleOffice365SuiteSyncOutlookEventsGenerateToken"><u>here</u></a><span>
        </div>
        {/if}
      </div>
    </div>
    ...
    <div>
      ...
      <div class="col-md-12 manual-sync mb-15">
    ...
    <div class="note">
        <div class="col-md-12">
            <div class="col-md-12">
                <b>{vtranslate('LBL_NOTES', $QUALIFIED_MODULE)} </b>
                <ol>
