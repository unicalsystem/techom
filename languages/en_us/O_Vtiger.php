...
$languageStrings = array(
	...
	'LBL_VTIGER_CRM_HONEST_OPEN_SOURCE' => 'vtiger SRS On Demand',
	...
	'LBL_DEFAULT_REPLY_TO_INFO' => 'This setting is applicable only for direct emails from SRS. It doesn\'t affect emails sent from workflows, email campaigns, etc.', 
	...
	'LBL_ROLLUP_COMMENTS_INFO' => "If Roll up is set to 'On' comments on related records will be shown. 
								 For example, if you are viewing comments on an Client record, comments added to related Contacts, Opportunities, Tickets, ..etc would also be displayed.",
	...
	'LBL_INTERNAL_COMMENT_INFO' => 'The comment will only be seen by SRS users, if the internal comment checkbox is enabled. To notify customers (through configurable workflows or customer portal) leave this checkbox disabled',
	'LBL_CHANGE' => 'Change',
...
$jsLanguageStrings = array(
	...
	'JS_INTERNAL_COMMENT_INFO' => 'The comment will only be seen by SRS users, if the internal comment checkbox is enabled. To notify customers (through configurable workflows or customer portal) leave this checkbox disabled',
	...
	'JS_TAB_REORDERED' =>'Reordered',
	//Convert Lead
	'JS_CONVERT_LEAD_ERROR' => 'You have to enable either Clients or Contacts module to convert the Lead.',
