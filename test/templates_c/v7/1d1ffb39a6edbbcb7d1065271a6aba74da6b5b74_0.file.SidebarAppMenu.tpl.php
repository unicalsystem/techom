...
/* Smarty version 4.3.4, created on 2024-08-23 11:37:06
  from '/home/u255923749/domains/smartrecruitmentsolution.com/public_html/techom/layouts/v7/modules/Vtiger/partials/SidebarAppMenu.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_66c874626e1ff6_09940354',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1d1ffb39a6edbbcb7d1065271a6aba74da6b5b74' => 
    array (
      0 => '/home/u255923749/domains/smartrecruitmentsolution.com/public_html/techom/layouts/v7/modules/Vtiger/partials/SidebarAppMenu.tpl',
      1 => 1724413015,
      2 => 'file',
    ),
  ),
...
function content_66c874626e1ff6_09940354 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
">
            <span class="module-icon">
                <?php if ($_smarty_tpl->tpl_vars['moduleName']->value == 'Potentials') {?>
                    <img class="imageclass" src="layouts/v7/resources/Images/icons/openings-white.png" style="width: 26px; height: 27px;">
                <?php } elseif ($_smarty_tpl->tpl_vars['moduleName']->value == 'Accounts') {?>
                    <img class="imageclass" src="layouts/v7/resources/Images/icons/Clients-white.png" style="width: 27px; height: 27px;">
                <?php } elseif ($_smarty_tpl->tpl_vars['moduleName']->value == 'Contacts') {?>
                    <img class="imageclass" src="layouts/v7/resources/Images/icons/Contacts-white.png" style="width: 26px; height: 26px;">
                <?php } elseif ($_smarty_tpl->tpl_vars['moduleName']->value == 'Leads') {?>
                    <img class="imageclass" src="layouts/v7/resources/Images/icons/Profile-white.png" style="width: 26px; height: 26px; margin-top:-10px">
                 <?php } elseif ($_smarty_tpl->tpl_vars['moduleName']->value == 'Broadcast') {?>
    <i class="fas fa-broadcast-tower" style="color: white; margin-top:-30px"></i>
                <?php } else { ?>
...
<style>
    ...
    .module-item:hover .potentials-icon {
        fill: #ffffff;
    }
