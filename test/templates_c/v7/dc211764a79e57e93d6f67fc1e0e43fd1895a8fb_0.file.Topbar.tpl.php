<?php
/* Smarty version 4.3.4, created on 2024-09-05 11:01:47
  from '/home/u255923749/domains/smartrecruitmentsolution.com/public_html/techom/layouts/v7/modules/Vtiger/partials/Topbar.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_66d98f9bcbc8e0_01844970',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'dc211764a79e57e93d6f67fc1e0e43fd1895a8fb' => 
    array (
      0 => '/home/u255923749/domains/smartrecruitmentsolution.com/public_html/techom/layouts/v7/modules/Vtiger/partials/Topbar.tpl',
      1 => 1725534104,
      2 => 'file',
    ),
  ),
...
function content_66d98f9bcbc8e0_01844970 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
"><span id="adv-search" class="adv-search fa fa-chevron-circle-down pull-right cursorPointer" aria-hidden="true"></span></div></div></div><ul id="left-shortcuts" class="nav navbar-nav" style=" display: flex; align-items: center; margin-top: -8px"><li style="margin-right: 15px; text-align: center;"><a href="index.php?module=Accounts&amp;view=List&amp;app=SALES" title="Clients" class="shortcut-icon"><img src="layouts/v7/resources/Images/icons/Clients.png" alt="Clients" style="width: 25px; height: 25px;"><div class="shortcut-label">Clients</div></a></li><li style="margin-right: 15px; text-align: center;"><a href="index.php?module=Contacts&amp;view=List&amp;app=SALES" title="Contacts" class="shortcut-icon"><img src="layouts/v7/resources/Images/icons/Contacts.png" alt="Contacts" style="width: 22px; height: 24px;"><div class="shortcut-label">Contacts</div></a></li><li style="margin-right: 15px; text-align: center;"><a href="index.php?module=Potentials&amp;view=List&amp;app=SALES" title="Openings" class="shortcut-icon"><img src="layouts/v7/resources/Images/icons/openings.png" alt="Openings" style="width: 24px;height: 25px;"><div class="shortcut-label">Openings</div></a></li><li style="margin-right: 15px; text-align: center;"><a href="index.php?module=Leads&amp;view=List&amp;app=MARKETING" title="Profiles" class="shortcut-icon"><img src="layouts/v7/resources/Images/icons/Profile.png" alt="Profile" style="width: 22px; height: 25px;"><div class="shortcut-label">Candidates</div></a></li><li style="margin-right: 15px;"><div class="whatsapp-container"><a href="#" id="whatsapp-chat-icon" title="WhatsApp Chat" class="shortcut-icon" style="margin-top: -2px"><img src="layouts/v7/resources/Images/icons/whatsapp.png" alt="WhatsApp" style="width: 24px;height: 25px; margin-bottom: 1px"><div class="shortcut-label">WhatsApp</div></a><!-- WhatsApp Chat Widget --><div id="whatsapp-chat-widget" class="whatsapp-chat-widget"><div class="chat-header"><span>WhatsApp</span><div class="chat-header-icons"><i class="fa fa-search" id="search-icon"></i><i class="fa fa-sign-out" id="logout-icon"></i></div><div id="search-container" style="display: none;"><input type="text" id="search-input" class="curved-input" placeholder="Search chats..." style="color:#050505;"></div><span id="close-chat" class="close-chat">&times;</span></div><div id="chat-inbox" class="chat-body"><!-- Inbox items will be dynamically added here --></div><div id="chat-conversation" class="chat-body" style="display: none;"><div class="conversation-header"><i class="fa fa-arrow-left back-to-inbox"></i><div class="profile-pic"></div><span class="contact-name" ></span></div><div class="messages"><!-- Messages will be dynamically added here --></div><div class="chat-footer"><div id="message-input-area"><i class="fa fa-smile-o"></i><i class="fa fa-paperclip"></i><input type="text" placeholder="Type a message"><button class="send-message-btn" type="button"><i class="fa fa-paper-plane"></i></button></div><div id="template-message-area" style="display: none;"><div class="template-message-container"><p>Chat passed the 24-hour window</p><button class="send-template-btn" type="button">Send Template</button></div></div></div></div></div></div></li></ul><div id="navbar" class="col-sm-6 col-xs-12 collapse navbar-collapse navbar-right global-actions"><ul class="nav navbar-nav" style="margin-top: -8px"><li><div class="dropdown pull-left"><div class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><a href="#" id="menubar_quickCreate" class="" title="<?php echo vtranslate('LBL_QUICK_CREATE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" aria-hidden="true"><img src="layouts/v7/resources/Images/icons/Contacts-white.png" alt="Create" style="width: 25px; height: 25px;"></a></div><ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" style="width:500px;"><li class="title" style="padding: 5px 0 0 15px;"><strong><?php echo vtranslate('LBL_QUICK_CREATE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</li><li id="VtigerAction"><a href="javascript:Documents_Index_Js.uploadTo('Vtiger')"><img style=" margin-right: 4%;" title="Vtiger" alt="Vtiger" src="layouts/v7/skins//images/Vtiger.png"><?php ob_start();
...
" aria-hidden="true"><img src="layouts/v7/resources/Images/icons/Calender.png" alt="Calendar" style="width: 23px; height: 25px;"></a></div></li><?php }
$_smarty_tpl->_assignInScope('REPORTS_MODULE_MODEL', Vtiger_Module_Model::getInstance('Reports'));
if ($_smarty_tpl->tpl_vars['USER_PRIVILEGES_MODEL']->value->hasModulePermission($_smarty_tpl->tpl_vars['REPORTS_MODULE_MODEL']->value->getId())) {?><li><div><a href="index.php?module=Reports&view=List" title="<?php echo vtranslate('Reports','Reports');?>
" aria-hidden="true"><img src="layouts/v7/resources/Images/icons/Report.png" alt="Reports" style="width: 23px; height: 25px;"></a></div></li><?php }
if ($_smarty_tpl->tpl_vars['USER_PRIVILEGES_MODEL']->value->hasModulePermission($_smarty_tpl->tpl_vars['CALENDAR_MODULE_MODEL']->value->getId())) {?><li><div><a href="#" class="taskManagement" title="<?php echo vtranslate('Tasks','Vtiger');?>
" aria-hidden="true"><img src="layouts/v7/resources/Images/icons/Task.png" alt="Tasks" style="width: 23px; height: 25px;"></a></div></li><?php }?><li class="dropdown"><div><a href="#" class="userName dropdown-toggle pull-right" data-toggle="dropdown" role="button"><img src="layouts/v7/resources/Images/icons/Profilesetting.png" alt="Profile Settings" style="width: 23px; height: 25px;"><span class="" aria-hidden="true" title="<?php echo $_smarty_tpl->tpl_vars['USER_MODEL']->value->get('userlabel');?>
...
</a></span></div></div></div></div></li></ul></div></div></div><link rel="stylesheet" href="layouts/v7/modules/Vtiger/partials/WhatsAppPopup.css"><link rel="stylesheet" href="https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">


<?php echo '<script'; ?>
 src="layouts/v7/modules/Vtiger/resources/WhatsAppPopup.js"><?php echo '</script'; ?>
>
